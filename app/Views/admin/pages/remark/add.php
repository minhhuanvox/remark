    ...
    <div class="main-wrapper container">
      ...
      <div class="formbold-main-wrapper">
        ...
        <div class="formbold-form-wrapper">
          <form action="admin/remark/create" method="POST">
            ...
            <div class="formbold-input-flex">
              <div>
                ...
                <input type="text" name="student-id" placeholder="3119410001" max="10" class="formbold-form-input"
                  required />
              </div>
            ...
            <div class="formbold-input-flex">
              ...
              <div>
                ...
                <input type="text" name="phone_number" max="10" placeholder="Nhập số điện thoại"
